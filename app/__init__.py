...
def index():
    return render_template(
        "index.html", title="Firstname Lastname", url=os.getenv("URL")
    )
...
def form():
    ...
    server.sendmail(
        "abeaboagye7@gmail.com", "abeaboagye7@gmail.com", name + " " + email + " " + msg
    )
...
def projects():
    ...
    robotics_projects = [
        "Sumo Robot/sumo.jpg",
        "Line Following Robot/line_follower.png",
        "Soccer Robot/soccer_robot.jpeg",
        "Fire Extinguishing Robot/fire_robot.jpg",
    ]
    electronics_projects = [
        "Cell Phone Detector/Cell-phone-detector.jpg",
        "Mobile Jammer Circuit/Mobile-Jammer.jpg",
    ]
